window.__ModuleLoader__.load({
  ...
  `;
		...
		function summarizePanel(providers, pools, loading) {
			...
			for (const name of providers) {
				...
				for (const masked of pool.maskedKeys) if ((pool.states[masked]?.cooldownUntil || 0) > now) cooling += 1;
			}
			const parts = [`${providerCount} provider${providerCount === 1 ? "" : "s"}`, `${keyCount} key${keyCount === 1 ? "" : "s"}`];
			if (cooling > 0) parts.push(`${cooling} cooling`);
			return parts.join(" · ");
		}
		function ApiKeyPoolCard() {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				className: `akp-card${panelOpen ? " open" : ""}`,
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
					...
					children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
						className: "akp-panel-toggle-main",
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: "akp-panel-title",
							children: "API Key Pool"
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							className: "akp-panel-sub",
							children: summarizePanel(allProviders, state.pools, state.loading)
						})]
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
