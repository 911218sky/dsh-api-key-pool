window.__ModuleLoader__.load({ id: "dsh-api-key-pool", factory: (require) => {
var module = { exports: {} };
	...
	return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		children: [
			...
			/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
				className: "akp-desc",
				children: "Round-robin keys per provider. Failed keys (401/403/429/…) cool down, then the next key is used."
			}),
